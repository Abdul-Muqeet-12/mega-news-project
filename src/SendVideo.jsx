...
export default function SendVideo() {
  ...
  return (
    <>
        ...
        <div className="explanation flex flex-col lg:flex-row items-start gap-6">
          ...
          <div className="explain w-full lg:w-2/3">
            ...
            <div className="btns flex flex-wrap gap-3 mb-6">
              ...
              <Link to={"/send-video"}>
                <div className="send-video px-4 py-2 rounded-xl flex items-center justify-center gap-2 bg-[#F5F5F5]">
      ...
      <div className="mx-auto px-2 sm:px-4 lg:px-8 my-8">
        <div className="text-[16px] font-medium text-[#3E3232]">
          Image Gallery
        </div>
        <div className="flex items-center sm:flex-row flex-col gap-[10px]">
          <div className="w-full sm:w-[230px] h-[290px] mt-2 flex items-center justify-center rounded-xl shadow-sm bg-[#F5F5F5]">
            <label className="w-[90%] h-[90%] border border-dashed border-[#E1E1E1] rounded-xl flex items-center justify-center cursor-pointer relative">
              {file ? (
                <div className="text-center">
                  <p className="text-sm text-gray-600">{file.name}</p>
          ...
          <div className="imgs grid md:grid-cols-5 sm:grid-cols-4 small:grid-cols-4 2small:grid-cols-2 gap-2">
            ...
            <div className="w-[100px] h-[100px] rounded-xl bg-[#00000033] relative">
              ...
              />
              <RiDeleteBinLine className="absolute top-7 right-7 text-[40px] text-white" />
            </div>

            <div className="w-[100px] h-[100px] rounded-xl bg-[#F5F5F5] border border-[#E1E1E1] flex items-center justify-center text-[40px] text-[#3E323240]">
              <FaRegImage />
            </div>
            <div className="w-[100px] h-[100px] rounded-xl bg-[#F5F5F5] border border-[#E1E1E1] flex items-center justify-center text-[40px] text-[#3E323240]">
              <FaRegImage />
