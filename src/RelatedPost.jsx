      ...
      <Slider {...settings}>
        {posts.map((post) => (
          <div key={post.id} className="px-2">
            <div className="lg:w-[290px] w-full h-[350px] mb-6 shadow-md hover:shadow-lg rounded-xl flex flex-col justify-between">
              <div className="boat-img flex justify-center">
                <div className="lg:w-[270px] w-[95%] h-[150px] rounded-xl mt-2">
                  <img
                    src={post.img}
                    alt={post.title}
                    className="rounded-xl lg:w-[270px] w-full h-[160px] object-cover"
                  />
                </div>
              </div>
              <div className="flex flex-col gap-3">
                ...
                <div className="flex justify-center mb-3">
                  <div className="lg:w-[270px] w-[95%] h-[72px] rounded-xl bg-[#F5F5F5] flex justify-between items-center px-4">
