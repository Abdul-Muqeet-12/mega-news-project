...
export default function ProfileMarked() {
  const posts = [
    {
      id: 1,
        ...
        <div className="lg:grid lg:grid-cols-4 mt-10">
          {posts.map((post) => (
            <div key={post.id} className="px-2">
              <div className="lg:h-[350px] lg:w-auto w-full h-[385px] sm:h-[180px] mb-6 hover:shadow-md rounded-xl flex lg:flex-col sm:flex-row flex-col lg:justify-between shadow-[0px_1px_10px_2px_#00000012]">
