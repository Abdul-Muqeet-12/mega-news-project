  ...
  return (
    <>
      ...
      <div className="links flex items-center gap-[10px] lg:mx-8 sm:mx-6 small:mx-3 mx-2 mt-10">
        <Link to={"/category"}>
          <div className="link-1 w-[40px] h-[40px] hover:shadow-sm rounded-xl flex items-center justify-center">
            <div className="text-[16px] font-medium text-[#3E3232]">1</div>
          </div>
        </Link>
        <Link to={"/category2"}>
          <div className="link-1 w-[40px] h-[40px] rounded-xl bg-[#F5F5F5] flex items-center justify-center hover:shadow-sm">
            <div className="text-[16px] font-medium text-[#3E3232]">2</div>
          </div>
        </Link>
        <Link to={"/category3"}>
          <div className="link-1 w-[40px] h-[40px] rounded-xl flex items-center justify-center hover:shadow-sm">
