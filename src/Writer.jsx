...
import { FaPlus, FaRegNewspaper, FaRegStar } from "react-icons/fa";
    ...
    <>
      ...
      <div className="bar h-[260px] bg-[#F5F5F5] rounded-xl lg:mx-8 sm:mx-6 small:mx-6 mx-6 mt-10 p-3">
        ...
        <div className="flex items-center justify-between mt-3">
          <div className="flex items-center gap-[8px]">
            ...
            <div className="lg:hidden sm:block hidden">
              <div className="flex items-center justify-between pb-2">
                ...
                <div className="text-sm font-medium text-white bg-[#F81539BF] w-[105px] h-[40px] cursor-pointer shadow-sm hover:shadow-md rounded-xl flex items-center justify-center gap-[8px] sm:hidden pr-2">
                  <FaPlus className="md:text-[12px] text-[10px]" /> Follow
                </div>
              </div>
          ...
          <div className="md:text-sm small:text-[12px] font-medium text-white bg-[#F81539BF] w-[105px] h-[40px] cursor-pointer shadow-sm hover:shadow-md rounded-xl sm:flex items-center justify-center gap-[8px] hidden pr-2">
            <FaPlus className="md:text-[12px] text-[10px]" /> Follow
          </div>
        </div>
      </div>
      ...
      <div className="links flex items-center gap-[8px] lg:mx-8 sm:mx-6 small:mx-3 mx-2 mt-10">
        <Link to={"/category"}>
          <div className="link-1 w-[35px] h-[35px] hover:shadow-sm bg-[#F5F5F5] rounded-xl flex items-center justify-center">
            <div className="text-[16px] font-medium text-[#3E3232]">1</div>
          </div>
        </Link>
        <Link to={"/category2"}>
          <div className="link-2 w-[35px] h-[35px] rounded-xl flex items-center justify-center hover:shadow-sm">
